...
def display_processes(processes):
    ...
    print(f"{'PID':<6} {'Name':<25} {'CPU%':>5} {'RAM in MB':>10}")
    print("-" * 60)
    for process in processes:
        # Print process details with RAM in MB
        print(f"{process['pid']:<6} {process['name']:<25} {process['cpu_percent']:>5} {process['memory_usage_mb']:>10.2f}")
