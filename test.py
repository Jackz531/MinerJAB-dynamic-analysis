...
PIDs = test_data['pid']
y_test = test_data['Cryptojacker or not']
...
for pid, actual, predicted in zip(PIDs, y_test, test_data['Predicted']):
    actual_label = label_encoder.inverse_transform([actual])[0]
    print(f'PID: {pid}, Actual Label: {actual_label}, Predicted Label: {predicted}')   
